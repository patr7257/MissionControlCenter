...
```
cd C:\Users\pr\repos\1-Personal\MissionControlCenter\desktop; npm install; npm start
```
...
```
cd C:\Users\pr\repos\1-Personal\MissionControlCenter\desktop; npm run dist
```
